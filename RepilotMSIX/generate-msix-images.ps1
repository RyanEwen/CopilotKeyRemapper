# Generates the MSIX visual assets (gradient + keyboard glyph) into Images\.
...
# Full-bleed gradient square with a centered glyph (tiles, logos).
...
# Transparent splash with a centered rounded-gradient badge.
